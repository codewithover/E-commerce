    ...
    return (
        <div className="shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between">
                ...
                <button className="ring-gray-200 shadow-lg rounded-md px-2 py-1 text-sm cursor-pointer hover:text-black hover:bg-white transition-all  duration-200 flex items-center gap-2">
