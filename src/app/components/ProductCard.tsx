    ...
    return (
        <div className="shadow-lg rounded-lg overflow-hidden">
                    ...
                    productTypes.color === color
                      ...
                      : "border-gray-200"
                             ...
                             key={color} onClick={()=>(handleProductType({type:"color" , value:color}))}>
                                <div className="w-[14px] h-[14px] rounded-full " style={{background:color}} />
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="flex items-center justify-between">
                ...
                <button onClick={handleAddToCart} className="ring-gray-200 shadow-lg rounded-md px-2 py-1 text-sm cursor-pointer hover:text-black hover:bg-white transition-all  duration-200 flex items-center gap-2">
